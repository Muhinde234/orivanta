...
export default function ProcessSection() {
  ...
  return (
    <section className="py-20 lg:py-24 bg-white" aria-labelledby="process-heading">
              ...
              return (
                ...
                >
                  ...
                  <div className="relative inline-flex flex-col items-center mb-5">
                    <div className="w-12 h-12 rounded-full bg-[#F8FAFC] border-2 border-[#E5E7EB] group-hover:border-[#C9A227] group-hover:bg-[#10243B] flex items-center justify-center transition-all duration-400 mb-3 relative z-10">
                      <Icon size={20} className="text-[#10243B] group-hover:text-[#C9A227] transition-colors duration-400" />
                    </div>
                  ...
                  <p className="text-gray-500 text-sm sm:text-[15px] leading-relaxed">{step.desc}</p>
                </motion.div>
              );
            })}
          </div>
