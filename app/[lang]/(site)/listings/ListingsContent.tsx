...
import { Listing, PROPERTY_TYPES, PURPOSES, PropertyType, Purpose, propertyTypeLabel, purposeLabel } from '@/lib/listings';
  ...
  return (
    <>
      <PageBanner
        ...
        subtitle={t('listings_subtitle')}
        breadcrumbs={[{ label: t('nav_home'), href: '/' }, { label: t('nav_listings') }]}
      />
      ...
      <CTASection
        title={t('listings_cta_title')}
        subtitle={t('listings_cta_subtitle')}
        primaryLabel={t('listing_contact_team')}
        primaryHref="/contact"
        secondaryLabel={t('listings_cta_secondary')}
