...
export const metadata: Metadata = {
  title: 'Contact Us',
  description:
    'Get in touch with AXIOM Realty Consultant Ltd for professional real estate advisory services in Rwanda. Request a consultation, ask questions, or visit our office in Kigali.',
  alternates: { canonical: `${BASE_URL}/contact` },
  openGraph: {
    url: `${BASE_URL}/contact`,
    title: 'Contact AXIOM Realty Consultant Ltd | Kigali, Rwanda',
    ...
    images: [{ url: '/images/og-default.jpg', width: 1200, height: 630, alt: 'Contact AXIOM Realty' }],
  },
};
