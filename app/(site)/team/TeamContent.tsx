            ...
            >
              ...
              <div className="relative">
                ...
                <div className="flex gap-3 mt-5 justify-center">
                  <a href={member.linkedin} aria-label="LinkedIn" className="w-10 h-10 rounded-full bg-[#10243B] flex items-center justify-center hover:bg-[#C9A227] transition-colors duration-300 text-white hover:text-[#10243B]">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"/><rect width="4" height="12" x="2" y="9"/><circle cx="4" cy="4" r="2"/></svg>
                  </a>
                  <a href={`mailto:${member.email}`} aria-label="Email" className="w-10 h-10 rounded-full bg-[#10243B] flex items-center justify-center hover:bg-[#C9A227] transition-colors duration-300 text-white hover:text-[#10243B]">
                    <Mail size={16} />
                  </a>
                </div>
              </div>
